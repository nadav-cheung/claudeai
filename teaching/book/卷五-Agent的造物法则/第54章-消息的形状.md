...
export class MessageBuilder {
  ...
  async userImage(filePath: string, mediaType: "image/png" | "image/jpeg"): Promise<this> {
    const block = await imageToBlock(filePath, mediaType);
...
[← 上一章：第 53 章 一个HTTP请求之外](./第53章-一个HTTP请求之外.md) | [下一章：第 55 章 文字如溪流 →](./第55章-文字如溪流.md)
